...
# Convert OLMO to transformer checkpoint, which supports OLMO for CausalLM
"""
Sample usage:
```
...
def main():
    # python open_instruct/olmo_hf/convert_olmo_to_tf.py --input_dir ${base_dir}/output/olmo1b_ckpts/checkpoint-738000 --tokenizer_json_path ${base_dir}/output/olmo1b_ckpts/checkpoint-738000/tokenizer.json --output_dir ${base_dir}/output/olmo1b_tf_ckpts/checkpoint-738000
